...
|---|-------|------|--------------|------------------|
| 01 | Multi-Person Marker UI | Build the toggle and canvas interface securely without touching backend APIs. | TRYON-01, TRYON-02, TRYON-03 | 3 |
| 02 | Engine Orchestration | Inject the marker data natively into the Gemini sequence and prompt logic. | TRYON-04, TRYON-05, TRYON-06 | 3 |
