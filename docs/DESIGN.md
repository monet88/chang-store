...
> **Historical reference only.** The active design authority is `docs/design-guidelines.md`. Do not use this document as implementation guidance unless a future design review explicitly promotes specific details back into the canonical redesign contract.
