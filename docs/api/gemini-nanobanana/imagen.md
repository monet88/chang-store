...
Get started generating images with the Gemini API
...
| --- | --- |
| Short prompts let you generate an image quickly. | Longer prompts let you add specific details and build your image. |
...
To use this style, start with using keywords that clearly tell Imagen that you're looking for a photograph. Start your prompts with _"A photo of. . ."_.
...
4. **Camera Settings** - _motion blur, soft focus, bokeh, portrait_
...
- Prompt: _A woman, 35mm portrait, blue and grey duotones_ (Model: `imagen-3.0-generate-002`)
- Prompt: _A woman, 35mm portrait, film noir_ (Model: `imagen-3.0-generate-002`)
...
- Prompt: _leaf of a prayer plant, macro lens, 60mm_ (Model: `imagen-3.0-generate-002`)
- Prompt: _a plate of pasta, 100mm Macro lens_ (Model: `imagen-3.0-generate-002`)
...
- Prompt: _a winning touchdown, fast shutter speed, movement tracking_ (Model: `imagen-3.0-generate-002`)
- Prompt: _A deer running in the forest, fast shutter speed, movement tracking_ (Model: `imagen-3.0-generate-002`)
...
- Prompt: _an expansive mountain range, landscape wide angle 10mm_ (Model: `imagen-3.0-generate-002`)
- Prompt: _a photo of the moon, astro photography, wide angle 10mm_ (Model: `imagen-3.0-generate-002`)
...
| Token limits | **Input token limit** 480 tokens (text) **Output images** 1 to 4 (Ultra/Standard/Fast) |
...
| Supported data types | **Input** Text **Output** Images |
| Token limits | **Input token limit** N/A **Output images** Up to 4 |
