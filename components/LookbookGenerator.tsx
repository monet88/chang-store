...
- **Detailed Description**: "${clothingDescription.trim()}"
    ...
    const outputContainerClasses = `relative w-full bg-zinc-900/50 rounded-2xl border border-zinc-800 p-2 sm:p-4 min-h-[50vh] lg:min-h-0 lg:h-full ${generatedLookbook ? '' : 'flex items-center justify-center'
        }`;
                            ...
                            <div className="flex flex-wrap justify-center gap-2 bg-zinc-800/50 p-1.5 rounded-lg">
                                {lookbookStyles.map(style => (
                                    <button
                                        ...
                                        className={`px-4 py-1.5 text-sm font-semibold rounded-md capitalize transition-colors duration-200 ${lookbookStyle === style.key ? 'bg-gradient-to-r from-amber-500 to-orange-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                            }`}
                                    >
                                        {style.label}
                                    </button>
                        ...
                        <div className="flex flex-col items-center gap-2 pt-4 border-t border-zinc-700/50 animate-fade-in">
                            ...
                            <div className="flex gap-2 bg-zinc-800/50 p-1.5 rounded-lg">
                                <button
                                    ...
                                    className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-colors duration-200 ${foldedPresentationType === 'boxed' ? 'bg-amber-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-colors duration-200 ${foldedPresentationType === 'folded' ? 'bg-amber-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                        }`}
                                >
                        ...
                        <div className="flex flex-col items-center gap-2 pt-4 border-t border-zinc-700/50 animate-fade-in">
                            ...
                            <div className="flex gap-2 bg-zinc-800/50 p-1.5 rounded-lg">
                                <button
                                    ...
                                    className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-colors duration-200 ${garmentType === 'one-piece' ? 'bg-amber-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-colors duration-200 ${garmentType === 'two-piece' ? 'bg-amber-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-colors duration-200 ${garmentType === 'three-piece' ? 'bg-amber-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                        }`}
                                >
                            ...
                            <div className="flex flex-wrap justify-center gap-2 bg-zinc-800/50 p-1.5 rounded-lg">
                                {MANNEQUIN_BACKGROUND_STYLES.map(style => (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 text-xs font-semibold rounded-md capitalize transition-colors duration-200 ${mannequinBackgroundStyle === style.key ? 'bg-amber-600 text-white' : 'text-zinc-300 hover:bg-zinc-700/50'
                                            }`}
                                    >
                                        {style.label}
                                    </button>
                            ...
                            <div className="flex-shrink-0 flex justify-center border-b border-zinc-700">
                                {outputTabs.map(tab => (
                                    <button
                                        ...
                                        className={`px-4 py-2 text-sm font-semibold transition-colors ${activeOutputTab === tab.id
