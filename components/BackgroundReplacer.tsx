  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col gap-6">
        <div>
          <h2 className="text-2xl font-bold text-center mb-1">{t('background.title')}</h2>
      ...
      <div className="sticky top-8 h-full">
        <div className="relative w-full h-full bg-zinc-900/50 rounded-2xl border border-zinc-800 p-4 flex flex-col">
            {isLoading ? (
