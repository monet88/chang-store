...
export const ImageGalleryProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt: Overriding the above decision. We must wrap the context value in useMemo
  // to preserve object identity and prevent massive cascading re-renders across all
  // consumer components when the Provider's parent re-renders without state changes.
