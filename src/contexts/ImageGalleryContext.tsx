...
export const ImageGalleryProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt: Override - Wrapping Context Provider value in useMemo to preserve object identity
  // and prevent massive cascading re-renders across all consumer components, especially since this is high in the tree.
