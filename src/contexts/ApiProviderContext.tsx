...
export const ApiProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt: Optimize context value to prevent cascading re-renders.
  // Memoizing this object and its setter callbacks ensures that consumers only re-render
  // when a value they actually depend on changes, rather than on every state change.
