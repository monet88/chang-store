        ...
        <div className="w-full h-full flex flex-col gap-4">
            ...
            <div className="flex-shrink-0 bg-zinc-900/50 p-4 rounded-lg border border-zinc-700 space-y-4">
                ...
                <div className="flex gap-2">
                    ...
                    />
                    <button onClick={handleRefineClick} disabled={isRefining || !refinePrompt.trim()} className="bg-amber-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-amber-500 disabled:bg-zinc-600 disabled:cursor-not-allowed transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500">
