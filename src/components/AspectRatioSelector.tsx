      ...
      <div className="flex flex-wrap justify-center gap-2 rounded-2xl border border-white/8 bg-white/[0.03] p-1.5">
        {RATIOS.map(ratio => (
          <button
            ...
            className={`flex min-h-[44px] min-w-[44px] items-center justify-center rounded-xl px-3 py-2 text-sm font-semibold transition-colors duration-200 ${aspectRatio === ratio ? 'bg-white text-zinc-950' : 'text-zinc-300 hover:bg-white/6'
              }`}
          >
            {ratio}
          </button>
