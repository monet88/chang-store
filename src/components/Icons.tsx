...
// Bookmark icon for Prompt Library FAB
...
/** Cloud icon for Google Drive / cloud storage indicators */
...
export const CopyIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v8.25A2.25 2.25 0 006 18.75h2.25m5.25-12h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 18V8.25" />
    </svg>
);
...
export const CropIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 9.25V4.5a.75.75 0 01.75-.75h4.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 14.75V19.5a.75.75 0 01-.75.75h-4.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12h15" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15" />
  </svg>
);

// FIX: Added DeleteIcon
...
// Paper plane icon for sending/transferring images to other features
...
// FIX: Added PerspectiveCropIcon
export const PerspectiveCropIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5l16.5 2.25M3.75 19.5l16.5-2.25M3.75 4.5v15M20.25 6.75v10.5" />
  </svg>
);
...
/** Refresh/sync icon for Drive sync status */
...
// FIX: Added ReloadIcon
export const ReloadIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.696L19.015 5.182a8.25 8.25 0 00-11.667 0L2.985 9.855z" />
  </svg>
);

// FIX: Added RotateIcon
...
// FIX: Added SelectionIcon
export const SelectionIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.875 14.25l-4.125-4.125a3.375 3.375 0 014.773-4.773l8.25 8.25a3.375 3.375 0 010 4.773l-4.125 4.125" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75v3.75m0 0l-1.5 1.5M12 7.5l1.5 1.5" />
  </svg>
);
...
// FIX: Add UserIcon to fix import error.
...
/** Warning/error icon for sync errors and alerts */
