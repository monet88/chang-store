/**
 * GptAIEditor - Multi-image AI editing with @mention references
 *
 * Features:
 ...
 *
 * GPT studio clone of AIEditor (issue #152, ADR 0009): same layout and flow,
 * only the options panel differs.
 */
