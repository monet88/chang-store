            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="absolute right-2 top-2 rounded-full border border-white/10 bg-black/60 p-1.5 text-white opacity-0 transition-all duration-200 hover:bg-red-500/80 group-hover:opacity-100 focus:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
