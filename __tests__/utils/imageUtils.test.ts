...
describe('detectClosestAspectRatio', () => {
  ...
  it('detects 4:3 for landscape images', () => {
  ...
  it('detects 9:16 for tall smartphone portrait images', () => {
...
describe('detectImageAspectRatio', () => {
  it('returns fallback for empty or null image', async () => {
    expect(await detectImageAspectRatio(null)).toBe('3:4');
    expect(await detectImageAspectRatio(undefined, '9:16')).toBe('9:16');
  });

  it('detects ratio from base64 image data', async () => {
    // 1x1 PNG header
